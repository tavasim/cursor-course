...
/** Smaller input = faster LLM calls; README lead is usually enough for a short summary. */
const MAX_README_CHARS = 8000;
/** Caps completion length so structured summary + cool_facts return faster. */
const MAX_COMPLETION_TOKENS = 640;
