...
/**
 * Resolve API key from request: Authorization Bearer, x-api-key header, or JSON body.key.
 * @param {Request} request
 * @param {object} [body] - Pre-parsed body (optional); if omitted, body is not read here.
 * @param {string} [body.key]
 */
export function getApiKeyFromRequest(request, body) {
